...
INDOOR_SENSORS: tuple[IndoorSensorDescription, ...] = (
    ...
    IndoorSensorDescription(key="unit_system_number", translation_key="unit_system_number",
                             entity_category=EntityCategory.DIAGNOSTIC,
                             value_fn=lambda d: d.unit_system_number),
    IndoorSensorDescription(key="unit_address_number", translation_key="unit_address_number",
                             entity_category=EntityCategory.DIAGNOSTIC,
                             value_fn=lambda d: d.unit_address_number),
    IndoorSensorDescription(key="host_system_number", translation_key="host_system_number",
                             entity_category=EntityCategory.DIAGNOSTIC,
                             value_fn=lambda d: d.host_system_number),
    IndoorSensorDescription(key="host_address_number", translation_key="host_address_number",
                             entity_category=EntityCategory.DIAGNOSTIC,
                             value_fn=lambda d: d.host_address_number),
    IndoorSensorDescription(
